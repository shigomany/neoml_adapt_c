...
#error Unknown platform
	...
	CArchiveFile::CArchiveFile(const char *fileName, CArchive::TDirection direction, void *) : file(0)
	{
...
#error Unknown platform
	...
	CArchiveFile::CArchiveFile(const char *fileName, CArchive::TDirection direction, void *platformEnv) : file(0)
	{
...
void *CArchiveFileInit(
	const char *fileName,
	int direction)
{
	auto directionEnum = static_cast<CArchive::TDirection>(direction);;
	return new CArchiveFile(fileName, directionEnum);
}

void CArchiveFileDispose(void *ptr) {
	auto instance = static_cast<CArchiveFile*>(ptr);
	delete instance;
}


bool CArchiveFileIsOpen(void *ptr) {
	auto instance = static_cast<CArchiveFile*>(ptr);
	return instance->IsOpen();
}

const char *CArchiveFileGetFileName(void *ptr) {
	auto instance = static_cast<CArchiveFile*>(ptr);
	return instance->GetFileName();
}

int CArchiveFileRead(void *ptr, void *buffer, int bytesCount) {
	auto instance = static_cast<CArchiveFile*>(ptr);
	return instance->Read(buffer, bytesCount);
}

void CArchiveFileWrite(void *ptr, void *buffer, int bytesCount) {
	auto instance = static_cast<CArchiveFile*>(ptr);
